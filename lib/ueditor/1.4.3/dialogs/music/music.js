        ...
        _renderTemplate:function (data) {
            ...
            for (var i = 0, tmpList; tmpList = data[i++];) {
                ...
                if (i == 1) {
                    ...
                    if (data.length != 1) {
                        t.push('<div id="page.css' + i + '" onclick="music.onpageclick(' + i + ')" class="pageon">' + (i ) + '</div>');
                    }
                } else {
                    s.push('<div id="panel' + i + '" class="paneloff">');
                    t.push('<div id="page.css' + i + '" onclick="music.onpageclick(' + i + ')" class="pageoff">' + (i ) + '</div>');
                }
