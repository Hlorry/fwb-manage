...
vjs.Flash = vjs.MediaTechController.extend({
  ...
  init: function(player, options, ready){
    ...
    //    Not sure why that even works, but it causes the browser to look like it's continuously trying to load the page.css.
    ...
    if (options['iFrameMode'] === true && !vjs.IS_FIREFOX) {
      ...
      // Tried embedding the flash object in the page.css first, and then adding a place holder to the iframe, then replacing the placeholder with the page.css object.
      ...
      vjs.on(iFrm, 'load', vjs.bind(this, function(){
        ...
        // However, the main page.css would look like it was loading indefinitely (URL bar loading spinner would never stop)
